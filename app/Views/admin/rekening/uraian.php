    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href=" <?= base_url('rekening') ?> ">Rekening</a></li>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($daftar_rekening as $key => $value) { ?>
                                        <!-- html... -->
                                        <tr>
                                            <td> <?= $no++; ?> </td>
                                            <td> <?= $value->AN ?> </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i> Ubah Rekening</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <form action=" <?= base_url('rekening/hapus/' . $rekening->id_rekening) ?>" method="post">
                        ...
                        <table class="table table-borderless table-sm">
                            <tbody>
                                ...
                                <tr>
                                    <td scope="row" width="150px">Pemilik</td>
